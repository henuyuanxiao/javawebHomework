...
public class VideoSendServlet extends HttpServlet {
...
//        PrintWriter out = resp.getWriter();
        JDBCSearch search=new JDBCSearch();
        JDBCVideo jdbcVideo=new JDBCVideo();
        String keyword= (String) this.getServletContext().getAttribute("keyword");
        HttpSession session=req.getSession();
        session.setAttribute("keyword",keyword);
        LinkedList<video> videos = search.getResults(keyword);
